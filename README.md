...
<table>
  <tr>
    ...
    <td width="50%"><img src="docs/icons/apps.svg" width="22" alt=""> <strong>App control</strong><br><sub>Install, launch, background, force quit, clone, and remove Android apps—including APK, APKM, and split packages.</sub></td>
  </tr>
  <tr>
