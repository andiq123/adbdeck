...
<table>
  <tr>
    ...
    <td width="50%"><img src="docs/icons/apps.svg" width="22" alt=""> <strong>App control</strong><br><sub>Install, launch, clone, and remove Android apps—even split APK packages.</sub></td>
  </tr>
  <tr>
